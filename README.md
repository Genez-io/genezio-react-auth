...
# React app using Genezio Auth
In this project, we are creating a React application that uses Genezio Auth to register and login users.

## Prerequisites
- ✅ [NodeJs](https://nodejs.org/) >= 16.0.0
- ✅ [npm](https://genezio.com/)
- ✅ [genezio](https://genezio.com/)
- ✅ Address the TODOs in code that require you to add the GOOGLE_ID of your OAuth Application.
...
Deploy your project using the genezio deploy command from the ``./genezio-react-auth`` directory.
```
genezio deploy
```
